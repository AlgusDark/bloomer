...
describe('Column', () => {
  it('should render a div with .column', () => {
    ...
    expect(component.contains(<div className="column">Any Content</div>)).toBe(
      true
    );
  });
  ...
  it('should render a p with .column', () => {
    ...
    expect(component.contains(<p className="column">Any Content</p>)).toBe(
      true
    );
  });
  ...
  it('should render a div with .column, modifiers and custom classNames', () => {
    const component = shallow(<Column isSize="1/2" className="custom" />);
    expect(component.hasClass('column')).toBe(true);
  ...
  it('should render a div with .column, modifiers and custom classNames', () => {
    const component = shallow(<Column isSize="full" className="custom" />);
    expect(component.hasClass('column')).toBe(true);
  ...
  it('should render a div with .column and custom classNames', () => {
    const component = shallow(<Column className="custom" />);
    expect(component.hasClass('column')).toBe(true);
    expect(component.hasClass('custom')).toBe(true);
  });
});
