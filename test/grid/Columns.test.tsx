...
describe('Columns', () => {
  it('should render a div with .columns', () => {
    ...
    expect(component.contains(<div className="columns">Any Content</div>)).toBe(
      true
    );
  });
  ...
  it('should render a p with .columns', () => {
    ...
    expect(component.contains(<p className="columns">Any Content</p>)).toBe(
      true
    );
  });
  ...
  it('should render a div with .columns, modifiers and custom classNames', () => {
    const component = shallow(<Columns isMobile className="custom" />);
    expect(component.hasClass('columns')).toBe(true);
    expect(component.hasClass('is-mobile')).toBe(true);
  ...
  it('should render a div with .columns and custom classNames', () => {
    const component = shallow(<Columns className="custom" />);
    expect(component.hasClass('columns')).toBe(true);
    expect(component.hasClass('custom')).toBe(true);
  });
});
