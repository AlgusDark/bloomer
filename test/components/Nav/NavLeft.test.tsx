...
describe("NavLeft", () => {
  it("should render a div with .nav-left", () => {
    ...
    expect(component.contains(<div className="nav-left">My NavLeft</div>)).toBe(
      true
    );
  });
  ...
  it("should render a p with .nav-left", () => {
    ...
    expect(component.contains(<p className="nav-left">My NavLeft</p>)).toBe(
      true
    );
  });
