...
describe('CardFooterItem', () => {
  it('should render a custom component with CardFooterItem props', () => {
    ...
    const component = shallow(
      <CardFooterItem className="custom" render={customComponent} />
    );
  ...
  it('should render a p with .card-footer-item', () => {
    const component = shallow(
      <CardFooterItem>My CardFooterItem</CardFooterItem>
    );
    expect(
      component.contains(<p className="card-footer-item">My CardFooterItem</p>)
    ).toBe(true);
  });

  it('should render a div with .card-footer-item', () => {
    const component = shallow(
      <CardFooterItem tag="div">My CardFooterItem</CardFooterItem>
    );
    expect(
      component.contains(
        <div className="card-footer-item">My CardFooterItem</div>
      )
    ).toBe(true);
  });
  ...
  it('should render an anchor with .card-footer-item and custom classNames', () => {
    const component = shallow(
      <CardFooterItem href="#" className="custom">
        <span>Any CardFooterItem</span>
      </CardFooterItem>
    );
