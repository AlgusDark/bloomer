...
describe("CardHeader", () => {
  it("should render a header with .card-header", () => {
    ...
    expect(
      component.contains(<header className="card-header">My CardHeader</header>)
    ).toBe(true);
  });
  ...
  it("should render a div with .card-header", () => {
    ...
    expect(
      component.contains(<div className="card-header">My CardHeader</div>)
    ).toBe(true);
  });
