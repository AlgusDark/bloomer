...
describe("CardImage", () => {
  it("should render a div with .card-image", () => {
    ...
    expect(
      component.contains(<div className="card-image">My CardImage</div>)
    ).toBe(true);
  });

  it("should render a p with .card-image", () => {
    const component = shallow(<CardImage tag="p">My CardImage</CardImage>);
    expect(component.contains(<p className="card-image">My CardImage</p>)).toBe(
      true
    );
  });
  ...
  it("should render a div with .card-image and custom classNames", () => {
    const component = shallow(
      <CardImage className="custom">
        <span>Any CardImage</span>
      </CardImage>
    );
