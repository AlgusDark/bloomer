...
describe('NavbarItem', () => {
  ...
  it('should render a button with .navbar-item', () => {
    const component = shallow(
      <NavbarItem tag="button">My NavbarItem</NavbarItem>
    );
    expect(
      component.contains(<button className="navbar-item">My NavbarItem</button>)
    ).toBe(true);
  });
  ...
  it('should render a div with .navbar-item', () => {
    ...
    expect(
      component.contains(<div className="navbar-item">My NavbarItem</div>)
    ).toBe(true);
  });
