...
describe('NavbarMenu', () => {
    it('should render a nav with .navbar-menu', () => {
    ...
    it('should render a div with .navbar-menu', () => {
        const component = shallow(<NavbarMenu tag='div'>My Nav</NavbarMenu>);
        expect(component.contains(<div className='navbar-menu'>My Nav</div>)).toBe(true);
    });

     it('should render a nav with .navbar-menu and modifiers', () => {
     ...
     it('should render a nav with .navbar-menu, modifiers and custom classNames', () => {
    ...
    it('should render a nav with .navbar-menu and custom classNames', () => {
