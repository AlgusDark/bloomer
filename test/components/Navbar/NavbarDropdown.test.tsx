...
describe("NavbarDropdown", () => {
  it("should render a div with .navbar-dropdown", () => {
    const component = shallow(
      <NavbarDropdown>My NavbarDropdown</NavbarDropdown>
    );
    expect(
      component.contains(
        <div className="navbar-dropdown">My NavbarDropdown</div>
      )
    ).toBe(true);
  });
  ...
  it("should render a p with .navbar-dropdown", () => {
    const component = shallow(
      <NavbarDropdown tag="p">My NavbarDropdown</NavbarDropdown>
    );
    expect(
      component.contains(<p className="navbar-dropdown">My NavbarDropdown</p>)
    ).toBe(true);
  });
