...
describe('PanelTabs', () => {
  it('should render a div with .panel-tabs', () => {
    ...
    expect(
      component.contains(<div className="panel-tabs">My PanelTabs</div>)
    ).toBe(true);
  });

  it('should render a p with .panel-tabs', () => {
    const component = shallow(<PanelTabs tag="p">My PanelTabs</PanelTabs>);
    expect(component.contains(<p className="panel-tabs">My PanelTabs</p>)).toBe(
      true
    );
  });
