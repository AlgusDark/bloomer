...
describe("PanelHeading", () => {
  it("should render a paragraph with .panel-heading", () => {
    ...
    expect(
      component.contains(<p className="panel-heading">My PanelHeading</p>)
    ).toBe(true);
  });

  it("should render a div with .panel-heading", () => {
    const component = shallow(
      <PanelHeading tag="div">My PanelHeading</PanelHeading>
    );
    expect(
      component.contains(<div className="panel-heading">My PanelHeading</div>)
    ).toBe(true);
  });

  it("should render a paragraph with .panel-heading and custom classNames", () => {
    const component = shallow(
      <PanelHeading className="custom">
