...
describe('Ellipsis', () => {
  it('should render a span with .pagination-ellipsis', () => {
    ...
    expect(
      component.contains(<span className="pagination-ellipsis">…</span>)
    ).toBe(true);
  });
  ...
  it('should render a div with .pagination-ellipsis', () => {
    ...
    expect(
      component.contains(<div className="pagination-ellipsis">…</div>)
    ).toBe(true);
  });

  it('should render a span with .pagination-ellipsis with modifiers', () => {
    const component = shallow(
      <Ellipsis isActive isFocused className="custom" />
    );
