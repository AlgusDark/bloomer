...
describe('PageList', () => {
  it('should render a ul with .pagination-list', () => {
    ...
    expect(
      component.contains(<ul className="pagination-list">My Pagination</ul>)
    ).toBe(true);
  });
  ...
  it('should render a ol with .pagination-list', () => {
    ...
    expect(
      component.contains(<ol className="pagination-list">My Pagination</ol>)
    ).toBe(true);
  });

  it('should render a ul with .pagination-list and custom classNames', () => {
    const component = shallow(
      <PageList className="custom">
        <li>Any Content</li>
      </PageList>
    );
