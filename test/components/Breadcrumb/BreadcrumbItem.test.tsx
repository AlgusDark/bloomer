...
describe('BreadcrumbItem', () => {
  ...
  it('should render a ol', () => {
    const component = shallow(
      <BreadcrumbItem tag="ol">My Link</BreadcrumbItem>
    );
  ...
  it('should render a li with modifiers', () => {
    const component = shallow(
      <BreadcrumbItem isActive>My Link</BreadcrumbItem>
    );
  ...
  it('should render a li with modifiers and classNames', () => {
    const component = shallow(
      <BreadcrumbItem isActive className="custom">
        My Link
      </BreadcrumbItem>
    );
    expect(component.hasClass('is-active')).toBe(true);
  ...
  it('should render a li with classNames', () => {
    const component = shallow(
      <BreadcrumbItem className="custom">My Link</BreadcrumbItem>
    );
    expect(component.hasClass('custom')).toBe(true);
  });
});
