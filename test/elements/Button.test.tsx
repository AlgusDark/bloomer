...
describe("Button", () => {
  it("should render a custom component with Button props", () => {
    ...
    const component = shallow(
      <Button href="#" isLoading render={customComponent} />
    );
  ...
  it("should render an anchor with .button:disabled", () => {
    ...
    expect(
      component.contains(
        <a role="button" href="#" className="button" disabled />
      )
    ).toBe(true);
  });
  ...
  it("should render an anchor with .button", () => {
    ...
    expect(
      component.contains(<a role="button" href="#" className="button" />)
    ).toBe(true);
  });

  it("should render an anchor with .button with modifiers", () => {
    const component = shallow(<Button href="#" isLink isOutlined isInverted />);
  ...
  it("should render an anchor with .button and custom classNames", () => {
    const component = shallow(
      <Button href="#" isLink className="custom loader" />
    );
    expect(component.is("a")).toBe(true);
    expect(component.hasClass("button")).toBe(true);
    expect(component.hasClass("is-link")).toBe(true);
  ...
  it("should render a button with .button", () => {
    ...
    expect(
      component.contains(<button type="button" className="button" />)
    ).toBe(true);
  });
  ...
  it("should render a button with .button:disabled", () => {
    ...
    expect(
      component.contains(<button type="button" className="button" disabled />)
    ).toBe(true);
  });

  it("should render a button with .button with modifiers", () => {
    const component = shallow(<Button isLink isOutlined isInverted isStatic />);
