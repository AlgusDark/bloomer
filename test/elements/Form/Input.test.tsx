...
describe('Input', () => {
    it('should render a input with .input', () => {
        const component = shallow(<Input/>);
        expect(component.contains(<input type='text' className='input' />)).toBe(true);
    });

    it('should render a input with .input and modifiers', () => {
    ...
    it('should render a input with .input, modifiers and custom classNames', () => {
    ...
    it('should render a input with .input and custom classNames', () => {
