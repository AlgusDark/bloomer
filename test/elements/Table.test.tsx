...
describe('Table', () => {
  it('should render a table with .table', () => {
    ...
    expect(component.contains(<table className="table">My Table</table>)).toBe(
      true
    );
  });

  it('should render a table with .table and modifiers', () => {
    const component = shallow(<Table isBordered isStriped isNarrow />);
  ...
  it('should render a table with .table, modifiers and custom classNames', () => {
    const component = shallow(
      <Table isStriped className="custom">
