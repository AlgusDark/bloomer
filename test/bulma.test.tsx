...
describe("removeProps functions", () => {
  ...
  it("should remove Active props", () => {
    ...
    expect(Bulma.removeActiveModifiers({ ...props, ...stateProps })).toEqual(
      props
    );
  });
  ...
  it("should remove Hovered props", () => {
    ...
    expect(Bulma.removeHoveredModifiers({ ...props, ...stateProps })).toEqual(
      props
    );
  });
  ...
  it("should remove Focused props", () => {
    ...
    expect(Bulma.removeFocusedModifiers({ ...props, ...stateProps })).toEqual(
      props
    );
  });
  ...
  it("should remove Heading props", () => {
    ...
    expect(Bulma.removeHeadingProps({ ...props, ...HeadingProps })).toEqual(
      props
    );
  });
});
...
describe("withHelpersModifiers", () => {
  it("should render a Component without modification", () => {
    ...
    expect(
      shallow(<WithHelpersModifiersComponent />).contains(<Component />)
    ).toBe(true);
  });
  ...
  it("should render a Component with custom props", () => {
    ...
    const renderedComponent = (
      <WithHelpersModifiersComponent isColor="black" className="custom" />
    );
    expect(
      shallow(renderedComponent).contains(
        <Component isColor="black" className="custom" />
      )
    ).toBe(true);
  });
  ...
  it("should render a Component with .flex", () => {
    ...
    const WithHelpersModifiersComponent = Bulma.withHelpersModifiers(Component);
    const renderedComponent = (
      <WithHelpersModifiersComponent isDisplay="flex" className="custom" />
    );
    const shallowedComponent = shallow(renderedComponent);
  ...
  it("should render a Component with flex modifiers", () => {
    ...
    const WithHelpersModifiersComponent = Bulma.withHelpersModifiers(Component);
    const renderedComponent = (
      <WithHelpersModifiersComponent isHidden className="custom" />
    );
    const shallowedComponent = shallow(renderedComponent);
  ...
  it("should render a Component with flex modifiers", () => {
    ...
    const WithHelpersModifiersComponent = Bulma.withHelpersModifiers(Component);
    const renderedComponent = (
      <WithHelpersModifiersComponent isHidden="lol" className="custom" />
    );
    const shallowedComponent = shallow(renderedComponent);
  ...
  it("should render a Component with flex modifiers", () => {
    ...
    const WithHelpersModifiersComponent = Bulma.withHelpersModifiers(Component);
    const renderedComponent = (
      <WithHelpersModifiersComponent isHidden={false} className="custom" />
    );
    const shallowedComponent = shallow(renderedComponent);
  ...
  it("should render a Component without isFlex prop when someone provides bad data", () => {
    ...
    const WithHelpersModifiersComponent: any = Bulma.withHelpersModifiers(
      Component
    );
    const renderedComponent = (
      <WithHelpersModifiersComponent isDisplay="none" className="custom" />
    );
    const shallowedComponent = shallow(renderedComponent);
  ...
  it("should render a Component withouth errors when passing bad data to isFlex", () => {
    ...
    const renderedComponent = (
      <WithHelpersModifiersComponent isDisplay={1} className="custom" />
    );
    const shallowedComponent = shallow(renderedComponent);
